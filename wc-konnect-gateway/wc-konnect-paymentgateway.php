...
function init_wc_konnect_gateway()
{
    ...
    class wc_konnect_gateway extends WC_Payment_Gateway
    {
        public function __construct() {
            ...
            $this->title 			        = "Cartes bancaires";
            $this->description 		        = "Payer avec une carte bancaire ou un compte Konnect";
        ...
        public function init_form_fields()
        {
            $this->form_fields = array(
                    ...
                    'Wallet' => array(
                        ...
                        'type' => 'checkbox',
                        'label' => __('Activer paiement avec Wallet Konnect', 'konnect-payments'),
                        'default' => 'yes'
                    ),
                    'E-dinar' => array(
